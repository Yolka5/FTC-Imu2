...
public class finalAutoLeft extends LinearOpMode {
    ...
    Pose2d EndPose = new Pose2d(-38.5, -19.5, Math.toRadians(171.5));
...
//--------------------------------------------------------------------------------------
        ...
        TrajectorySequence getToJunction = drive.trajectorySequenceBuilder(new Pose2d(-36, -60, Math.toRadians(90)))
                .forward(45)
                .lineToLinearHeading(new Pose2d(-40, -20, Math.toRadians(179)))
                .build();
        TrajectorySequence getToPark = drive.trajectorySequenceBuilder(EndPose)
                .lineToLinearHeading(new Pose2d(-34, -36, Math.toRadians(300)))
                .build();
