...
public class FinalAutoRight1 extends LinearOpMode {
    ...
    Pose2d GroundPose = new Pose2d(41, -20.5, Math.toRadians(77.5));
...
//--------------------------------------------------------------------------------------
        ...
        TrajectorySequence getToJunction = drive.trajectorySequenceBuilder(new Pose2d(36, -60, Math.toRadians(90)))
                .forward(45)
                .lineToLinearHeading(new Pose2d(36.7, -21.5, Math.toRadians(0)))
                .lineToLinearHeading(EndPose)
                .build();
        TrajectorySequence getToPark = drive.trajectorySequenceBuilder(GroundPose)
                .lineToLinearHeading(new Pose2d(42, -30, Math.toRadians(-103)))
                .lineToLinearHeading(new Pose2d(43, -32, Math.toRadians(-87)))
                .build();
        ...
        Trajectory trajectorySignalTwo = drive.trajectoryBuilder(new Pose2d())
                .strafeRight(10)
                .build();
        TrajectorySequence getToGround = drive.trajectorySequenceBuilder(EndPose)
                .lineToLinearHeading(GroundPose)
                .build();
...
//second cycle
                ...
                drive.followTrajectorySequence(getToGround);
                ClawPos = 0;
                Claw.setPosition(ClawPos);
                sleep(200);
                Armservo.setPosition(ArmIntoCone);
                sleep(300);
                drive.setPoseEstimate(GroundPose);
