...
public class AutonomRedLeft extends LinearOpMode {
...
//        drive.followTrajectory(trajectoryForward);
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            telemetry.update();
            correction = (600 - colorSensor.red());
            correction = correction / 700;
            ...
            if (!Starting) {
                ...
                if (Starting && !SawRed && colorSensor.red() < 450) {
                    telemetry.addData("driving to red", "driving to red");
                    drive.setMotorPowers(0.2, 0.2, 0.2, 0.2);
                } else if (Starting && !SawRed && colorSensor.red() >= 450) {
                    SawRed = true;
                    ClawPos = 0;
