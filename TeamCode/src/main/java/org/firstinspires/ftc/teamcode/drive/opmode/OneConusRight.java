...
public class OneConusRight extends LinearOpMode {
    public static double SPEED = 0.15;
    boolean Starting = false;
    int ConusIndex = 0;
    double value;

    public static double FirstDistance = 48.5;
    OpenCvCamera camera;
...
//        drive.followTrajectory(trajectoryForward);
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            if (!Starting) {
                ...
                drive.followTrajectory(trajectoryBackFromParkingConus);
